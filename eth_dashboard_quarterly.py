...
description = "Deribit ETH Quarterly Options"
...
def run():
    ...
    def load_data():
        ...
        with fs.open("ethxp/dfQuarterly.parquet", 'rb') as f:
    ...
    try:
        ...
        # Render
        st.write("### Past Data for Deribit ETH Quarterly Options", data.sort_index())
