...
description = "Deribit ETH Smesterly Options"
...
def run():
    ...
    def load_data():
        ...
        with fs.open("ethxp/dfSemesterly.parquet", 'rb') as f:
    ...
    try:
        ...
        # Render
        st.write("### Past Data for Deribit ETH Semesterly Options", data.sort_index())
